...
const addNewOrder = (order) => {
  ...
  const sqlQuery = 'INSERT INTO orders (user_id, restaurant_id, total, date, status) VALUES ($1, $2, $3, $4, $5) RETURNING*;';
  ...
  return pool
    ...
    .then((res) => {
      console.log("After query db inside addneworder ---->", res.rows);
      return res.rows;
    })
